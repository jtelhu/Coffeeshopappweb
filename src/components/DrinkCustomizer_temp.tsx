...
export function DrinkCustomizer({ drink, onAddToCart, onCancel }: DrinkCustomizerProps) {
  ...
  const selectedClass = 'border-red-600 bg-red-50 text-red-600';
  const unselectedClass = 'border-gray-200 bg-white text-gray-700';

  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <div className="sticky top-16 bg-white border-b border-gray-200 p-4 flex items-center justify-between z-10">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 lg:p-6">
        <div className="max-w-5xl mx-auto">
          <button
            ...
            className="w-full bg-black text-white py-4 rounded-lg hover:bg-gray-800 transition-colors flex items-center justify-between px-6"
          >
